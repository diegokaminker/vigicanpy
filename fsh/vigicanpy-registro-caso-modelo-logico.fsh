Logical:    ModeloLogicoRegistroCaso
Title:     "Registro Caso"
Description:    "Modelo Lógico de Registro de Caso - Corresponde a la Interaccion 01-Registrar Caso"
Parent: Element
...
* ficha 1..1 BackboneElement "Datos de la Ficha"
  * numeroLocalRegistro 0..1 Identifier "Numero asignado por el sistema generador del caso"
  * numeroUnicoRegistro 0..1 Identifier "En caso de alta, lo asigna el sistema receptor"
